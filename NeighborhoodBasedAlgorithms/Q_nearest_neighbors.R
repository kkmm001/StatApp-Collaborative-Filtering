Q_nearest_neighbors = function(userID, movieID, Q, list.dejaVu, vect.Users, mat.sim){
  ...
  # OUTPUT  mat.neighbors   : les identifiants des (au plus) Q plus proches voisins pour le film movieID pour userID et leur degré de similarité
  
  # Plus spécifiquement, cette fonction retourne la matrice de taille Qx2 contenant les valeurs 
  ...
  while((nb.Neighbors < Q) & (userIND2 <= nb.OtherUsers)){
